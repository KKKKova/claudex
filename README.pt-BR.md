...
- Windows: baixe o binário pré-compilado em [Releases](https://github.com/StringKe/claudex/releases)
...
Mapeie o seletor `/model` do Claude Code (haiku/sonnet/opus/fable) para os modelos de qualquer provedor:
